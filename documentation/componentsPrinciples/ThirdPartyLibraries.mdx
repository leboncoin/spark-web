...
<Meta
  title="Components Principles/Third-party libraries"
  summary="Reference guide listing Spark components and their underlying third-party library dependencies, including migration plans to Base UI."
/>
