...
export const components = [
  ...
  {
    name: 'Checkbox',
    intents: ['main', 'support', 'accent', 'success', 'alert', 'danger', 'info', 'neutral'],
    designs: [],
    shapes: [],
    sizes: [],
    states: [],
    defaults: { intent: 'support' },
  },
  {
    name: 'CheckboxGroup',
    intents: [],
  ...
  },
  {
    ...
    sizes: [],
    states: [],
    defaults: { design: 'outlined', intent: 'support' },
  },
  {
    name: 'Collapsible',
    intents: [],
  ...
  },
  {
    ...
    intents: ['support', 'neutral', 'success'],
    designs: [],
    shapes: [],
    sizes: ['sm', 'md', 'lg'],
    states: [],
    defaults: { intent: 'support', size: 'lg' },
  },
  {
    name: 'RadioGroup',
    intents: ['main', 'support', 'accent', 'success', 'alert', 'danger', 'info', 'neutral'],
  ...
  },
  {
    ...
    sizes: ['sm', 'md'],
    states: [],
    defaults: { intent: 'support', size: 'sm' },
  },
  {
    name: 'Tabs',
    intents: ['main', 'support'],
    designs: [],
    shapes: [],
    sizes: ['xs', 'sm', 'md'],
    states: [],
    defaults: { intent: 'support', size: 'md' },
  },
  {
    name: 'Tag',
    intents: [
    ...
    sizes: ['md', 'lg'],
    states: [],
    defaults: { design: 'filled', intent: 'support', size: 'md', shape: 'pill' },
  },
  {
    name: 'TextareaGroup',
    intents: [],
