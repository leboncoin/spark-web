...
<Meta title="Contributing/Commit Strategy" />
...
Nx Release uses conventional commits to automatically determine version bumps (patch, minor, major) based on commit messages. The commitlint configuration enforces the conventional commit format.
