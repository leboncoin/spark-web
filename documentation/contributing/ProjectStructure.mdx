...
- **Build** : Uses Vite for TypeScript compilation and type generation
...
- **Build** : Compilation with Vite for multi-format compatibility
...
@theme {
  ...
  --spacing-sm: 0.5rem;
  --spacing-md: 1rem;
  --font-sans: 'LBC Denim INK', ui-sans-serif, system-ui;
}
```
