...
<Meta title="Styling/Themes" summary="Configure light, dark, and high-contrast themes using data attributes, and create custom themes by overriding color tokens in your Tailwind configuration." />
...
@import '@spark-ui/theme-utils/base'; /* spark default theme */
