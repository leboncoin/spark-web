...
<Meta title="Styling/Animations" summary="Apply smooth CSS keyframe animations with customizable durations, easing functions, and predefined animations like slide, fade, scale, rotate, shake, and ping." />
...
<Callout kind="warning" marginY="large">
  <p>
    Rely on css transitions for simple animations. CSS keyframes are meant for complex animations.
  </p>
    ...
    <tr>
      ...
      <th style={{ minWidth: 300 }}>
        <div className="gap-lg flex items-center">
          ...
          >
            <Icon className="size-4">{isDurationPlaying ? <PauseOutline /> : <PlayFill />}</Icon>
  ...
  <tbody>
    {durationExamples.map((example, index) => (
      <tr key={index}>
        ...
        <td>
          <div className="bg-neutral-container from-main-container to-support-container flex flex-col items-start rounded-full bg-linear-to-r">
            <div
              className={`bg-main size-sz-12 relative translate-x-[6px] scale-200 rounded-full ${
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <code>animation-delay-1000</code>
      </td>
      <td>
        <code>0ms</code>
      </td>
    ...
    <tr>
      ...
      <td>
        <code>animation-iteration-infinite</code>, <code>animation-iteration-3</code>
      </td>
      <td>
        <code>1</code>
      </td>
...
setAnimationName(currentAnimation)
    ...
    return (
        <div className='sb-unstyled relative overflow-hidden w-full flex flex-col gap-sm'>
            <div className='relative w-full bg-neutral-container h-sz-96 border-sm border-support'>
                <div className={cx(
                    'flex items-center justify-center p-md text-caption',
                    'bg-support text-on-support rounded-sm size-sz-24 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2',
...
<div className="gap-lg grid grid-cols-2 sm:grid-cols-4">
...
<div className="gap-lg grid grid-cols-2 sm:grid-cols-4">
  <AnimationPreview
    animation="before:animate-ping"
    className="before:animation-duration-650 before:z-hide before:absolute before:size-full before:rounded-[inherit] before:bg-[inherit]"
  />
</div>
...
<div className="gap-lg grid grid-cols-2 sm:grid-cols-4">
  ...
  <AnimationPreview
    animation="animate-shake-x"
    className="animation-duration-500 animation-shake-intensity-50"
  />
  <AnimationPreview animation="animate-shake-y" className="animation-duration-500" />
  <AnimationPreview
    animation="animate-shake-y"
    className="animation-duration-500 animation-shake-intensity-50"
  />
</div>
...
<Dropdown.Item key={animation} value={`${animation}`}>{animation.replace('animate-', '')}</Dropdown.Item>
            ...
            <div className='relative overflow-hidden w-full bg-neutral-container h-full flex flex-col gap-sm'>
                <div className={cx(
                    'bg-support rounded-lg shadow-sm size-sz-80 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2',
                    animationName,
                    animationDuration,
                    animationEasing,
                    animationDelay,
