...
- updated vite dts types ([11b217f5f](https://github.com/leboncoin/spark-web/commit/11b217f5f))
...
- **components:** react 19 made explicit providers optional ([57050dfc2](https://github.com/leboncoin/spark-web/commit/57050dfc2))
...
This was a version bump only for @spark-ui/components to align it with other projects, there were no code changes.
...
- **components:** apply bold font only on formfield label ([c55605889](https://github.com/leboncoin/spark-web/commit/c55605889))
...
- **components:** clear stepper value trigger callback ([6edebcfb7](https://github.com/leboncoin/spark-web/commit/6edebcfb7))
...
- update minor versions of depepencies ([f55c1303a](https://github.com/leboncoin/spark-web/commit/f55c1303a))
...
- **components:** edit to debug changelog automatic updates ([c68fe5624](https://github.com/leboncoin/spark-web/commit/c68fe5624))
...
- **components:** forward focus on file deletion ([f8aaf8d](https://github.com/leboncoin/spark-web/commit/f8aaf8db2db15b7754ec150f82c70ddd2313bfb5))
...
- **components:** file upload FormField compatibility ([cda3005](https://github.com/leboncoin/spark-web/commit/cda30056241024f8fb461cfaf19a41311b017530))

## [11.4.3](https://github.com/leboncoin/spark-web/compare/v11.4.2...v11.4.3) (2025-11-18)

### Bug Fixes

- **components:** cleanup stories ([189df88](https://github.com/leboncoin/spark-web/commit/189df88356c777201c37e4f87f2e64635c080634))
...
## [11.2.4](https://github.com/leboncoin/spark-web/compare/v11.2.3...v11.2.4) (2025-11-06)

### Bug Fixes

- **components:** forward custom global toast manager ([65414e8](https://github.com/leboncoin/spark-web/commit/65414e89f430112857724d8ede3aca3ca68a8500))
...
- **components:** expose toast manager ([978e6e9](https://github.com/leboncoin/spark-web/commit/978e6e960d6b9c60b8b8814a2d58f81806b5e4e9))
...
## [11.1.3](https://github.com/leboncoin/spark-web/compare/v11.1.2...v11.1.3) (2025-10-31)
