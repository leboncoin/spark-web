...
A container for queued snackbars. It should be placed at the root of the app.
...
The component that display each snackbar's content.

<ArgTypes of={Snackbar.Item} />


### _.ItemIcon

The component that prepend an icon in the snackbar.

<ArgTypes of={Snackbar.ItemIcon} />


### _.ItemAction

The component that renders a button which action is safe to ignore.

<ArgTypes of={Snackbar.ItemAction} />

### _.ItemClose

The component that closes the snackbar.

<ArgTypes of={Snackbar.ItemClose} />

### addSnackbar

The function that triggers snackbars by adding them to a global queue.

<ArgTypes of={addSnackbar} />
