...
<Tag className='sb-unstyled'>Standalone</Tag>
<Canvas of={CheckboxStories.Default} />

<Tag className='sb-unstyled'>Group</Tag>
<Canvas of={CheckboxGroupStories.DefaultGroup} />
...
<Canvas of={CheckboxGroupStories.UncontrolledGroup} />
...
<Canvas of={CheckboxGroupStories.ControlledGroup} />
...
<Canvas of={CheckboxGroupStories.Intent} />
...
<Canvas of={CheckboxGroupStories.GroupOrientation} />
...
<Canvas of={CheckboxGroupStories.CustomImplementation} />
...
<Canvas of={CheckboxGroupStories.FieldHelperMessage} />
...
<Canvas of={CheckboxGroupStories.FieldHiddenLabel} />

### Label

Use `FormField.Label` to add a label to the input.

<Canvas of={CheckboxGroupStories.FieldLabel} />

### Required

Use the `isRequired` prop of the `FormField` to indicate that the input is required.

<Canvas of={CheckboxGroupStories.FieldRequired} />
...
<Canvas of={CheckboxGroupStories.FieldInvalid} />
