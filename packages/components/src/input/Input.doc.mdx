...
Add any type of component that will be displayed before the input field. This provides flexibility to include additional elements, such as buttons or dropdowns, to enhance the user interface and provide clear context or guidance to the user.

<ArgTypes of={InputGroup.LeadingAddon} />

### _.LeadingIcon

Prepend a decorative icon inside the input (to the left).

<ArgTypes of={InputGroup.LeadingIcon} />
...
<ArgTypes of={InputGroup.TrailingAddon} />
...
<Canvas of={InputStories.Uncontrolled} />
...
<Canvas of={InputGroupStories.Icons} />
...
<Canvas of={InputGroupStories.State} />
...
<Canvas of={InputStories.FieldCharactersCount} />

### Helper message

Use the `FormField.HelperMessage` component to provide a description to the input.

<Canvas of={InputStories.FieldHelperMessage} />
...
<Canvas of={InputStories.FieldHiddenLabel} />

### Label

Use `FormField.Label` to add a label to the input.

<Canvas of={InputStories.FieldLabel} />
...
<Canvas of={InputStories.FieldRequired} />
...
<Canvas of={InputStories.FieldInvalid} />
