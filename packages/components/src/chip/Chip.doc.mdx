...
Component for offering information
...
<ArgTypes of={Chip.Content} />


### _.LeadingIcon

Prepend a decorative icon inside the chip (to the left).

<ArgTypes of={Chip.LeadingIcon} />


### _.TrailingIcon

Append a decorative icon inside the chip (to the right).

<ArgTypes of={Chip.TrailingIcon} />
