...
<Callout kind="warning">
  <p>
    Only use non-interactive, text-based elements in <code>title</code> and <code>description</code> props. Avoid interactive elements like buttons, inputs, or clickable components as they may cause accessibility and usability issues.
  </p>
</Callout>
