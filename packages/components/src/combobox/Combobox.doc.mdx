...
Multiple selection only. Displays selected items as chips inside the trigger.

<ArgTypes of={Combobox.SelectedItems} />
...
<ArgTypes of={Combobox.LeadingIcon} />

### _.Disclosure

Optional visual button to open and close the combobox items list.

<ArgTypes of={Combobox.Disclosure} />
...
The part that is toggled and portaled when the trigger element is clicked.

<ArgTypes of={Combobox.Popover} />  

### _.Items

The wrapper which contains all the options.

<ArgTypes of={Combobox.Items} />
