...
- Use the `design` prop to set the different look and feels of a button.
- Use the `intent` prop to set the color intent of a button.
- Use the `underline` prop to set the underline style of a button.
