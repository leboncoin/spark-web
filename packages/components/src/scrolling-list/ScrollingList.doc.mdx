...
<ArgTypes of={ScrollingList.Item} />
...
<ArgTypes of={ScrollingList.Controls} />
...
<ArgTypes of={ScrollingList.PrevButton} />
...
<ArgTypes of={ScrollingList.NextButton} />
...
<ArgTypes of={ScrollingList.SkipButton} />
...
This example demonstrates a scrolling list with an indeterminate number of items, each with a dynamic width.

This is to show you that the snapping points are calculated from the natural width of the items, and not from the width of the container.

<Canvas of={stories.FixedSizeItems} />
