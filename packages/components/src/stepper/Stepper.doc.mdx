...
If the value is empty (unset or cleared) and `minValue|maxValue` set to limitate value to strictly positive or negative values then increment and decrement buttons will be disabled accordingly.
