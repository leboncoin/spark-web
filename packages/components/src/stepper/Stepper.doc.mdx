...
A container for all the stepper component parts.
...
The input field to display and change the value.

<ArgTypes of={Stepper.Input} />
...
<ArgTypes of={Stepper.IncrementButton} />

### _.DecrementButton

The button to decrement the value of the input.

<ArgTypes of={Stepper.DecrementButton} />
...
Use `Stepper` without buttons to create a standalone stepper.
