...
import { ComponentPropsWithoutRef, Fragment, Ref, useCallback, useEffect, useRef } from 'react'
...
export const Input = ({
  ...
  const { state, actions, refs } = useAutoSuggest()
    ...
    <>
      ...
      <PopoverTrigger {...popoverTriggerProps}>
        <input
          ...
          ref={ref}
          id={`${snap.id}-input`}
          data-spark-component="autosuggest-input"
