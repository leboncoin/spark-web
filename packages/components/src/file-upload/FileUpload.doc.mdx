...
A drag-and-drop interface that allows users to upload files by dragging them onto the dropzone or clicking to browse files.

Using `FileUpload.Trigger` inside a dropzone is optional.
